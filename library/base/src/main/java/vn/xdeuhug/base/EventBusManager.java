...
public final class EventBusManager {
    ...
    /**
     * Gửi sự kiện dính. Nếu bạn dựa vào hai EventBus cùng lúc trong dự án của mình, vui lòng sử dụng API của EventBus mà bạn muốn sử dụng để gửi các sự kiện cố định.
     *
     * @param event 事件
     */
    ...
    /**
     * Hủy đăng ký các sự kiện dính. Nếu bạn dựa vào hai EventBus cùng lúc trong dự án của mình, vui lòng sử dụng API của EventBus mà bạn muốn sử dụng để hủy đăng ký các sự kiện cố định.
     *
     * @param eventType
     * @param <T>
     * @return
