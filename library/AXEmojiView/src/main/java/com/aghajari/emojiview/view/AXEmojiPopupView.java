...
public class AXEmojiPopupView extends FrameLayout implements AXPopupInterface {
    ...
    void updateKeyboardStateOpened(final int keyboardHeight) {
        ...
        if (listener != null)
            listener.onKeyboardOpened(findHeightWithSearchView(popupWindowHeight));
    ...
    public void hideSearchView(boolean l) {
        if (searchView == null || !searchView.isShowing() || (searchViewValueAnimator != null && searchViewValueAnimator.isRunning()))
            return;
