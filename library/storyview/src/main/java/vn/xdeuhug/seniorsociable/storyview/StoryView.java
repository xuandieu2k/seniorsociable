package vn.xdeuhug.seniorsociable.storyview;
...
import vn.xdeuhug.seniorsociable.storyview.R;
import vn.xdeuhug.seniorsociable.storyview.callback.OnStoryChangedCallback;
import vn.xdeuhug.seniorsociable.storyview.callback.StoryCallbacks;
import vn.xdeuhug.seniorsociable.storyview.callback.StoryClickListeners;
import vn.xdeuhug.seniorsociable.storyview.callback.TouchCallbacks;
import vn.xdeuhug.seniorsociable.storyview.model.MyStory;
import vn.xdeuhug.seniorsociable.storyview.progress.StoriesProgressView;
import vn.xdeuhug.seniorsociable.storyview.utils.PullDismissLayout;
import vn.xdeuhug.seniorsociable.storyview.utils.StoryViewHeaderInfo;
import vn.xdeuhug.seniorsociable.storyview.utils.ViewPagerAdapter;
import vn.xdeuhug.seniorsociable.storyview.utils.Utils;
    ...
    private void updateHeading() {
        ...
        if (storiesList.get(counter).getDate() != null) {
            titleTextView.setText(titleTextView.getText()
                    + " "
                    + Utils.getDurationBetweenDates(storiesList.get(counter).getDate(), Calendar.getInstance().getTime())
            );
        }
    }
