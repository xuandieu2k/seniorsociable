...
class NestedLinearLayout @JvmOverloads constructor(
    ...
    override fun onTouchEvent(ev: MotionEvent): Boolean {
        ...
        when (event.actionMasked) {
            ...
            MotionEvent.ACTION_CANCEL, MotionEvent.ACTION_UP -> {
                ...
                activePointerId =
                    vn.xdeuhug.widget.layout.NestedLinearLayout.Companion.INVALID_POINTER
                endDrag()
            }
    ...
    override fun onNestedScroll(
        ...
        if (dyUnconsumed > 0 && this.scrollY == 0) {
            scrollToTopListener?.onScrollToTop()
        }
    ...
    private var scrollToTopListener: OnScrollToTopListener? = null

    fun setOnScrollToTopListener(listener: OnScrollToTopListener) {
