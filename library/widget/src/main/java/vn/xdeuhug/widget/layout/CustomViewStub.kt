package vn.xdeuhug.widget.layout
...
class CustomViewStub @JvmOverloads constructor(
    ...
    private var listener: vn.xdeuhug.widget.layout.CustomViewStub.OnViewStubListener? = null
     ...
     * 设置监听器
     */
    fun setOnViewStubListener(listener: vn.xdeuhug.widget.layout.CustomViewStub.OnViewStubListener?) {
    ...
    interface OnViewStubListener {
         ...
         */
        fun onInflate(stub: vn.xdeuhug.widget.layout.CustomViewStub, inflatedView: View)
         ...
         */
        fun onVisibility(stub: vn.xdeuhug.widget.layout.CustomViewStub, visibility: Int)
    }
}